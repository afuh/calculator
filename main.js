...
const app = (function(){
  ...
  //It receives an array and maps it into three grups 'prev', 'operator' and 'next'. Then it uses the method 'evaulue.operation' to return the result.
  ...
  $(document).on("click", "button", function() {
    ...
    //Every time a button is pressed run all the tests.
    evaluation(input);
  });
